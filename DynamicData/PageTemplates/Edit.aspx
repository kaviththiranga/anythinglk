<%@ Page Language="C#" MasterPageFile="~/Administrator/anythingadmin.master" CodeFile="Edit.aspx.cs" Inherits="Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="widget-head orange"><h3>Edit  <%= table.DisplayName %></h3></div>
